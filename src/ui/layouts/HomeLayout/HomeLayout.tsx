        ...
        <div className={classnames(section)}>
          ...
          <div className={classnames(margin('mb-2'))}>
            ...
            <p className={classnames(text)}>
              ...
              if you want to generate code for a plain JavaScript project. This project is not
              actively maintained, but the goal is to eventually update Sequelize UI to support
          ...
          <div className={classnames(margin('mb-2'))}>
            ...
            <p className={classnames(text)}>
              ...
              after the code generated by Sequelize Auto. Because Sequelize Auto is meant to
              generate code for an existing database, it does not generate any migration files.
